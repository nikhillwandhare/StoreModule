                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">NX</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="mobile-menu">
                                <nav id="dropdown">
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">${data.userName} <span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                                ...
                                <div class="sparkline11-graph dashone-comment dashtwo-comment comment-scrollbar">
                                    <div class="daily-feed-list">
                                        <div class="daily-feed-img">
                                            <a href="#"><img src="${pageContext.request.contextPath}/resources/images/notification/1.jpg" alt="" />
                                            </a>
                                        </div>
                                    ...
                                    <div class="daily-feed-list">
                                        <div class="daily-feed-img">
                                            <a href="#"><img src="${pageContext.request.contextPath}/resources/images/notification/2.jpg" alt="" />
                                            </a>
                                        </div>
                                        <div class="daily-feed-content">
                                    ...
                                    <div class="daily-feed-list">
                                        <div class="daily-feed-img">
                                            <a href="#"><img src="${pageContext.request.contextPath}/resources/images/notification/3.jpg" alt="" />
                                            </a>
                                        </div>
                                        <div class="daily-feed-content">
                                    ...
                                    <div class="daily-feed-list">
                                        <div class="daily-feed-img">
                                            <a href="#"><img src="${pageContext.request.contextPath}/resources/images/notification/4.jpg" alt="" />
                                            </a>
                                        </div>
                                        <div class="daily-feed-content">
                                    ...
                                    <div class="daily-feed-list">
                                        <div class="daily-feed-img">
                                            <a href="#"><img src="${pageContext.request.contextPath}/resources/images/notification/5.jpg" alt="" />
                                            </a>
                                        </div>
                                        <div class="daily-feed-content">
                                    ...
                                    <div class="daily-feed-list">
                                        <div class="daily-feed-img">
                                            <a href="#"><img src="${pageContext.request.contextPath}/resources/images/notification/6.jpg" alt="" />
                                            </a>
                                        </div>
                                        <div class="daily-feed-content">
